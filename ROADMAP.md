...
| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 281 | `SC01` | `doing` | S | GS01 | Opt-in Domain status/transition catalog + doctor residual when the map is thin; skills stay at 100% product |

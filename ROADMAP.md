...
`K01`. No new skill names. Absence never invents residual. Engineering doing: none — `LD01`–`LD05` done (adopt writes / place reads layer captions). Next is `LD06`.

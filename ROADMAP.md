...
**Live validation (amarilla worktree, 2026-07-17, local build):** doctor over the real tree now
...
`x03FamilyInfra.test.ts` with amarilla's verbatim layer names (13/13 total), X07 case in

...
`K01`. No new skill names. Absence never invents residual. Engineering doing: none — `LD01` done (ADR 0035 accepted). Next is `LD02`.
...
Engineering doing: none. Phase **LD** `LD01` **done** (ADR 0035); `LD02`–`LD06` **todo**. Phase **LV** `LV01`–`LV09` **done** (4.8.6 published). `AGY01` **done** (4.8.5 published). `OR01`–`OR07` **done**. `WH01` **done** (ADR 0026). `PK01` **done**.

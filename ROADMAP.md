...
not a fail, silent when that doc is absent. No status-field sensor (Holding).
No `schemaVersion` bump. No new skill. Does not close `Z09` / `K01`.

| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 280 | `GS01` | `doing` | S | AP01 | Doctor next-step for missing/incomplete states/transitions artifact; conventional domain homes; skills stay at 100% product |

...
| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 290 | `RL816` | `doing` | S | CR01 | Prepare **4.8.16** (daily accumulate #255–#257, #259, #260). After merge: annotated tag `v4.8.16` + GitHub Release + `gh workflow run publish-npm.yml -f tag=v4.8.16 -f dry_run=false`. Does not close `Z09` / `K01` |
...
| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 290 | `AP02` | `doing` | S | AP01 | ADR/decision-note path tied to policy weaken + new layer/allow edge; skills stay at 100% product |

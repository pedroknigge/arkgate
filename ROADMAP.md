...
| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 286 | `RL815` | `doing` | S | LC01 | Prepare **4.8.15** (`--local` #251 + dogfood honesty #252). After merge: annotated tag `v4.8.15` + GitHub Release + `gh workflow run publish-npm.yml -f tag=v4.8.15 -f dry_run=false`. Does not close `Z09` / `K01` |

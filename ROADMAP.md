...
| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 276 | `HR01` | `doing` | S | — | Hook `classifyProbe` reuses `layerForRelativePath` + ark-check specifier extensions; explicit file beats `src/lib/**`. LEXICAL copy names `ark-check` as authority. #237 |

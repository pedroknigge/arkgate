...
Engineering doing: none — Phase LV done; 4.8.6 tree ready (not published).
...
Engineering doing: none. Phase **LV** `LV01`–`LV09` **done** (4.8.6 tree ready, not published). `AGY01` **done** (4.8.5 published). `OR01`–`OR07` **done**. `WH01` **done** (ADR 0026). `PK01` **done**.

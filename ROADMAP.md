...
| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 279 | `AP01` | `doing` | S | LO01 | Soft ADR presence under `--require-gates` / adopted-strict; doctor next-step; conventional `docs/adr` homes; skills stay at 100% product |

...
Engineering doing: none — `LV06` done; next `doing` is `LV07`.
...
Engineering doing: none. Phase **LV** `LV01`–`LV06` **done**; `LV07`–`LV09` **todo**. `AGY01` **done** (4.8.5 published). `OR01`–`OR07` **done**. `WH01` **done** (ADR 0026). `PK01` **done**.

...
| Order | ID | Status | Size | Depends on | Outcome |
|---:|---|---|---:|---|---|
| 275 | `UC01` | `doing` | S | WG01 | Refuse when include matches files and zero are classified; write hook denies the same files. Partial unclassified stays a warning. Report modes still diagnose. |

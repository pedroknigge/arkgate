...
| [arkrun](docs/plans/arkrun/README.md) | In progress (`RN01`–`RN12` implemented; ADRs [0020](docs/adr/0020-arkrun-gated-extra-plane.md)–[0024](docs/adr/0024-arkrun-transport-ports.md) accepted; `RN13`–`RN16` `todo`; target **4.7.0**) | ArkRun gated extra: opt-in like ArkRules; enforced usage + complete declarations on the write/CI plane; companion `@arkgate/runtime` stays isolated; does not close Z09/K01 |

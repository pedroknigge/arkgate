...
| Releases (prepared / last published) | [CHANGELOG.md](CHANGELOG.md) · [4.5.7](docs/releases/4.5.7.md) (published) · [4.5.6](docs/releases/4.5.6.md) · [4.5.5](docs/releases/4.5.5.md) · [4.5.0](docs/releases/4.5.0.md) · [4.4.0](docs/releases/4.4.0.md) · [4.3.0](docs/releases/4.3.0.md) |
...
| [shared-home-skills-truth](docs/plans/shared-home-skills-truth/README.md) | Seeded for **4.5.8** (`HS01`–`HS06` `todo`) | Shared agent home skills: Claude/Grok monotonic home catalogs (Codex parity), doctor orphan honesty, always-latest additive floor |

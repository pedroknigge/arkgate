...
| [field-upgrade-mcp-truth](docs/plans/field-upgrade-mcp-truth/README.md) | Shipped in **4.5.6** (`FX01`–`FX11` done; `FX12` npm published — MCP/site close-out) | Field gaps + close-out: upgrade/MCP/skills honesty (`FX01`–`FX09`), `/review` (`FX10`), prepare docs/audit for 4.5.6 (`FX11`), publish + site (`FX12`) |

...
| Releases (prepared / last published) | [CHANGELOG.md](CHANGELOG.md) · [4.6.0](docs/releases/4.6.0.md) (prepared) · [4.5.7](docs/releases/4.5.7.md) (published) · [4.5.6](docs/releases/4.5.6.md) · [4.5.5](docs/releases/4.5.5.md) · [4.5.0](docs/releases/4.5.0.md) · [4.4.0](docs/releases/4.4.0.md) · [4.3.0](docs/releases/4.3.0.md) |
...
| [understandable-ark-4.6](docs/plans/understandable-ark-4.6/README.md) | In progress for **4.6.0** (`PL01`–`PL08` done; `PL09` publish) | Plain-language product surfaces + shared Claude/Grok home skills (Codex ratchet); former 4.5.8 HS absorbed |

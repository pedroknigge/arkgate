...
| [improvement-compass](docs/plans/improvement-compass/README.md) | Active for **4.4.0** (`IC01`–`IC06` done; next `IC07` release train) | Improvement compass (lenses, not scores) + vibe-coder skill deepen; public docs product-only (no roadmap-code narrative for consumers) |

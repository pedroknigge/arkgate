...
| [arkorder-valve-loop](docs/plans/arkorder-valve-loop/README.md) | In progress (`LV01` done; `LV02`–`LV09` `todo`) | Haken control loop: valve (`apply`), σ identity, ingest residual, capacity-as-data, ArkRun decision tape, `ReleaseStore` port. Target 4.9.0. [ADR 0034](docs/adr/0034-arkorder-valved-loop.md). Does not close Z09/K01. No Orderfield CLI |

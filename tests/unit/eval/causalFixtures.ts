...
export function makeManifest() {
  ...
  return {
    ...
    grader: {
      ...
      typeScriptHost: {
        version: '6.0.3',
        entrypoint: 'node_modules/typescript-ark-host/lib/tsc.js',
        sha256: pin('e'),
      },
    ...
    mutation: {
      ...
      configSha256: pin('e'),
      ranges: [
        { id: 'analysis-completeness', file: 'bin/lib/analysis-completeness.mjs', startLine: 9, endLine: 27, sourceSha256: pin('1') },
        { id: 'resolved-candidate-facts', file: 'bin/lib/resolved-candidate-facts.mjs', startLine: 684, endLine: 728, sourceSha256: pin('2') },
        { id: 'managed-upgrade', file: 'bin/lib/managed-upgrade.mjs', startLine: 233, endLine: 255, sourceSha256: pin('3') },
        { id: 'snapshot-invalidation', file: 'bin/lib/resident-hook.mjs', startLine: 115, endLine: 162, sourceSha256: pin('4') },
      ],
    },
  };
}

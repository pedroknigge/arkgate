          ...
          hooks: [
            {
              ...
              command: `${runner} ${PREFERRED_MCP_BIN} --hook --hook-repair --fail-on-new-smells --root "$CLAUDE_PROJECT_DIR" --config ark.config.json`,
            },
          ],
        },
      ],
          ...
          hooks: [
            {
              type: 'command',
              timeout: 30,
              command: `${runner} ${PREFERRED_MCP_BIN} --hook --hook-repair --fail-on-new-smells --root "${codexRoot}" --config ark.config.json`,
            },
          ],
        },
      ],
          ...
          hooks: [
            {
              ...
              command: `${runner} ${PREFERRED_MCP_BIN} --hook --hook-repair --fail-on-new-smells --root "${grokRoot}" --config ark.config.json`,
            },
          ],
        },
      ],

...
> **ArkGate 4.8.12** is prepared on this tree; npm `latest` remains **4.8.11**.
...
> [4.8.12 prepared](docs/releases/4.8.12.md) · [4.8.11 published](docs/releases/4.8.11.md) · [4.8.10](docs/releases/4.8.10.md) · [4.8.9](docs/releases/4.8.9.md) · [4.8.8](docs/releases/4.8.8.md) · [4.8.7](docs/releases/4.8.7.md) · [4.8.6](docs/releases/4.8.6.md) · [4.8.5](docs/releases/4.8.5.md) · [4.8.4](docs/releases/4.8.4.md) · [4.8.3](docs/releases/4.8.3.md) · [4.8.2](docs/releases/4.8.2.md) · [4.8.1](docs/releases/4.8.1.md) · [4.8.0](docs/releases/4.8.0.md) · [Docs hub](docs/README.md) · [Voice](docs/product-voice.md)
...
| Prepared (4.8.12; not published) | [docs/releases/4.8.12.md](docs/releases/4.8.12.md) · [CHANGELOG](CHANGELOG.md) |

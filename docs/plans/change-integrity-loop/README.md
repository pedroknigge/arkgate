...
5. Mark this plan `Complete (unreleased)` only after T01–T05 evidence and exact-SHA CI are green;
   mark it `Shipped` only after merge and publication.

...
| Epic plans | [plans/](plans/) — maintainer seeds, not required to use the package. Live: [alive-in-six-months](plans/alive-in-six-months/README.md) (`AL01`–`AL04` done; `AL05` parked). Next: [arkrun](plans/arkrun/README.md) (Phase RN in progress; `RN01`–`RN03` done; `RN04` implemented in tree; ADRs [0020](adr/0020-arkrun-gated-extra-plane.md)–[0024](adr/0024-arkrun-transport-ports.md) accepted; next `RN05`; target 4.7.0). |

...
Current published: [CHANGELOG](../CHANGELOG.md) (`arkgate@4.8.20` on npm `latest`; does not close `K01`). Plain-English history: [arkgate.online/changelog](https://www.arkgate.online/changelog/).

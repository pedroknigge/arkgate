...
| C-020 | Current release identity is aligned at 3.8.3 | [Release notes](../releases/3.8.3.md) | package/lock/version/server metadata | OK | release gate owns future sync |

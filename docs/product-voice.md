...
On the seven lane openings — `docs/use.md`, `docs/develop.md`, `docs/README.md`,
`docs/enthusiast/README.md`, `docs/agent-guide.md`, `docs/ai-gates.md`, and
`docs/package-surface.md` — use:
